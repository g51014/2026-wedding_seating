...
export const TABLES: TableDef[] = [
  ...
  { id: "13", label: "13", title: "新郎江紀武好友桌", seats: 10, diet: "全部葷食", x: 455, y: 650, side: "stage-left", zone: "面向舞台左側 · 走道旁" },
  { id: "14", label: "14", title: "新郎江紀武好友桌", seats: 10, diet: "全部葷食 · 另備兒童座椅 1（廖宇軒小朋友，不佔主位）", x: 455, y: 850, side: "stage-left", zone: "面向舞台左側 · 走道旁" },

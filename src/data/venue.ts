...
export const TABLES: TableDef[] = [
  ...
  { id: "6", label: "6", title: "葉家親友桌（9 席）", seats: 9, diet: "全部葷食 · 多一份餐", x: 369.7, y: 269.7, side: "stage-right", zone: "面向舞台右側 · 中排" },
  ...
  { id: "5", label: "5", title: "林家親友桌（8 席）", seats: 8, diet: "全部葷食 · 移餐至 1 桌 1 位、2 桌 1 位 · 多二份餐", x: 426.3, y: 298.5, side: "stage-right", zone: "面向舞台右側 · 靠牆" },
  { id: "9", label: "9", title: "林家親友桌（8 席）", seats: 8, diet: "全部葷食 · 移餐至 13 桌 2 位 · 多二份餐", x: 426.4, y: 368.3, side: "stage-right", zone: "面向舞台右側 · 靠牆" },
  { id: "10", label: "10", title: "預備桌", seats: 10, diet: "整桌預備 · 不列入移餐額度", x: 426.4, y: 441.7, side: "stage-right", zone: "面向舞台右側 · 靠牆" },
  { id: "11", label: "11", title: "仁寶科技桌", seats: 10, diet: "1 人不吃牛", x: 369.7, y: 471.7, side: "stage-right", zone: "面向舞台右側 · 中排" },
  ...
  { id: "15", label: "15", title: "江家親友桌（9 席）", seats: 9, diet: "2 人不吃牛", x: 158.1, y: 275.7, side: "stage-left", zone: "面向舞台左側 · 中排" },
  { id: "16", label: "16", title: "新郎父親好友桌", seats: 10, diet: "全部葷食", x: 158.1, y: 346.9, side: "stage-left", zone: "面向舞台左側 · 中排" },
  { id: "17", label: "17", title: "新郎父親好友桌（11 席）", seats: 11, diet: "1 人素食 · 餐自 15 桌", x: 158.2, y: 414.3, side: "stage-left", zone: "面向舞台左側 · 中排", coverFrom: "15" },
  { id: "19", label: "19", title: "新郎父親好友桌（9 席）", seats: 9, diet: "全部葷食", x: 158.1, y: 476.4, side: "stage-left", zone: "面向舞台左側 · 中排" },

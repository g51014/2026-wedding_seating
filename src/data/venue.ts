...
export const TABLES: TableDef[] = [
  ...
  { id: "1", label: "1", title: "女方艾克森桌", seats: 10, diet: "全部葷食", x: 314.2, y: 309.4, side: "stage-right", zone: "面向舞台右側 · 走道旁" },
  { id: "2", label: "2", title: "女方艾克森桌", seats: 10, diet: "全部葷食", x: 314.1, y: 379.1, side: "stage-right", zone: "面向舞台右側 · 走道旁" },
  { id: "3", label: "3", title: "女方萬里雲桌", seats: 10, diet: "全部葷食", x: 314.1, y: 452.4, side: "stage-right", zone: "面向舞台右側 · 走道旁" },
  { id: "6", label: "6", title: "女方媽媽親戚桌", seats: 10, diet: "全部葷食", x: 369.7, y: 269.7, side: "stage-right", zone: "面向舞台右側 · 中排" },
  { id: "7", label: "7", title: "女方仁寶桌", seats: 10, diet: "1 人不吃牛", x: 369.8, y: 334.9, side: "stage-right", zone: "面向舞台右側 · 中排" },
  { id: "8", label: "8", title: "女方創順與好友桌", seats: 10, diet: "全部葷食", x: 369.8, y: 404.8, side: "stage-right", zone: "面向舞台右側 · 中排" },
  { id: "5", label: "5", title: "女方爸爸親戚桌", seats: 10, diet: "全部葷食", x: 426.3, y: 298.5, side: "stage-right", zone: "面向舞台右側 · 靠牆" },
  { id: "9", label: "9", title: "女方爸爸親戚桌", seats: 10, diet: "全部葷食", x: 426.4, y: 368.3, side: "stage-right", zone: "面向舞台右側 · 靠牆" },
  { id: "10", label: "10", title: "女方爸爸親戚桌", seats: 10, diet: "全部葷食", x: 426.4, y: 441.7, side: "stage-right", zone: "面向舞台右側 · 靠牆" },
  ...
  { id: "15", label: "15", title: "江家長輩親友桌（超額 11 席）", seats: 11, diet: "2 人不吃牛 · 圓桌 10 位超額 1", x: 158.1, y: 275.7, side: "stage-left", zone: "面向舞台左側 · 中排" },
  ...
  { id: "20", label: "20", title: "江爸爸好友桌（超額 11 席）", seats: 11, diet: "1 人素食 · 圓桌 10 位超額 1", x: 104.4, y: 374.3, side: "stage-left", zone: "面向舞台左側 · 靠牆" },

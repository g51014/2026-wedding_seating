...
export const TABLES: TableDef[] = [
  ...
  { id: "1", label: "1", title: "艾克森科技／萬里雲科技桌（超額 12 席）", seats: 12, diet: "全部葷食 · 圓桌 10 位超額 2，餐具由 5 桌空位調配", x: 314.2, y: 309.4, side: "stage-right", zone: "面向舞台右側 · 走道旁", coverFrom: "5" },
  { id: "2", label: "2", title: "艾克森科技桌", seats: 10, diet: "1 人素食", x: 314.1, y: 379.1, side: "stage-right", zone: "面向舞台右側 · 走道旁" },
  { id: "3", label: "3", title: "創順科技桌（超額 11 席）", seats: 11, diet: "全部葷食 · 圓桌 10 位超額 1，餐具由 7 桌空位調配 · 另備兒童座椅 1（吳孟錡，不佔主位）", x: 314.1, y: 452.4, side: "stage-right", zone: "面向舞台右側 · 走道旁", coverFrom: "7", childSeats: ["吳孟錡"] },
  { id: "6", label: "6", title: "葉家親友桌（移餐額度 1）", seats: 10, diet: "全部葷食 · 空 1 席移給 17 桌", x: 369.7, y: 269.7, side: "stage-right", zone: "面向舞台右側 · 中排", spareCovers: 1, coverTo: "17" },
  { id: "7", label: "7", title: "林家親友桌（移餐額度 1）", seats: 10, diet: "全部葷食 · 空 1 席移給 3 桌", x: 369.8, y: 334.9, side: "stage-right", zone: "面向舞台右側 · 中排", spareCovers: 1, coverTo: "3" },
  { id: "8", label: "8", title: "仁寶科技桌", seats: 10, diet: "1 人不吃牛", x: 369.8, y: 404.8, side: "stage-right", zone: "面向舞台右側 · 中排" },
  { id: "5", label: "5", title: "林家親友桌（移餐額度 2）", seats: 10, diet: "全部葷食 · 空 2 席移給 1 桌，另 1 席保留", x: 426.3, y: 298.5, side: "stage-right", zone: "面向舞台右側 · 靠牆", spareCovers: 2, coverTo: "1" },
  { id: "9", label: "9", title: "林家親友桌（移餐額度 1）", seats: 10, diet: "全部葷食 · 空 1 席移給 13 桌，另 1 席保留", x: 426.4, y: 368.3, side: "stage-right", zone: "面向舞台右側 · 靠牆", spareCovers: 1, coverTo: "13" },
  { id: "10", label: "10", title: "女方（預備桌）", seats: 10, diet: "整桌預備 · 不列入移餐額度", x: 426.4, y: 441.7, side: "stage-right", zone: "面向舞台右側 · 靠牆" },
  { id: "11", label: "11", title: "萬里雲科技桌", seats: 10, diet: "全部葷食", x: 369.7, y: 471.7, side: "stage-right", zone: "面向舞台右側 · 中排" },
  { id: "12", label: "12", title: "新郎父親好友桌", seats: 10, diet: "全部葷食", x: 214.6, y: 308.7, side: "stage-left", zone: "面向舞台左側 · 走道旁（近主桌）" },
  { id: "13", label: "13", title: "伊諾科技桌（超額 11 席）", seats: 11, diet: "全部葷食 · 圓桌 10 位超額 1，餐具由 9 桌空位調配 · 另備兒童座椅 1（Lory，不佔主位）", x: 214.7, y: 378.5, side: "stage-left", zone: "面向舞台左側 · 走道旁", coverFrom: "9", childSeats: ["Lory"] },
  { id: "14", label: "14", title: "伊諾科技桌", seats: 10, diet: "全部葷食 · 另備兒童座椅 1（廖宇軒，不佔主位）", x: 214.6, y: 451.8, side: "stage-left", zone: "面向舞台左側 · 走道旁", childSeats: ["廖宇軒"] },
  { id: "15", label: "15", title: "江家親友桌", seats: 10, diet: "2 人不吃牛", x: 158.1, y: 275.7, side: "stage-left", zone: "面向舞台左側 · 中排" },
  { id: "16", label: "16", title: "新郎父親好友桌", seats: 10, diet: "全部葷食", x: 158.1, y: 346.9, side: "stage-left", zone: "面向舞台左側 · 中排" },
  { id: "17", label: "17", title: "新郎父親好友桌（超額 11 席）", seats: 11, diet: "1 人素食 · 圓桌 10 位超額 1，餐具由 6 桌空位調配", x: 158.2, y: 414.3, side: "stage-left", zone: "面向舞台左側 · 中排", coverFrom: "6" },
  { id: "19", label: "19", title: "新郎父親好友桌", seats: 10, diet: "全部葷食", x: 158.1, y: 476.4, side: "stage-left", zone: "面向舞台左側 · 中排" },

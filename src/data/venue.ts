...
export const TABLES: TableDef[] = [
  ...
  { id: "5", label: "5", title: "女方爸爸親戚桌（移餐額度 2）", seats: 10, diet: "全部葷食 · 空 2 席移給 1 桌", x: 426.3, y: 298.5, side: "stage-right", zone: "面向舞台右側 · 靠牆", spareCovers: 2, coverTo: "1" },
  { id: "9", label: "9", title: "女方爸爸親戚桌", seats: 10, diet: "全部葷食 · 空 2 席保留，不移餐", x: 426.4, y: 368.3, side: "stage-right", zone: "面向舞台右側 · 靠牆" },

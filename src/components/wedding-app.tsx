        ...
        <div className="mx-auto flex max-w-[1600px] flex-col gap-3 px-4 py-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-xl text-sm text-[#92400e]">
              場地依 Grand Ballroom I 示意圖：面對舞台左側 10 桌（男方 12–21）、右側 10 桌（女方 1–3、5–11，無 4 號）。伊諾科技在左側走道 13、14；13 桌 Lory、14 桌廖宇軒、3 桌吳孟錡另備兒童座椅。女方同事好友在右側走道 1、2、3；親屬 5、6、7、9。紅點為 1 號位，順時針。
            </p>
          </div>
      ...
      <main className="mx-auto max-w-[1600px] px-4 py-4">
          ...
          <TabsContent value="roster" className="print:hidden">
            <div className="mb-4 rounded-xl border border-amber-200 bg-[#fffaf3] p-4 text-sm leading-relaxed text-[#7c2d12]">
              場地與示意圖相同：左 10 桌（12–21）、右 10 桌。伊諾科技 13 桌超額 11 席、14 桌已排滿。兒童座椅（不佔主位）：3 桌吳孟錡、13 桌 Lory、14 桌廖宇軒。客桌最多可加兩張椅子，餐具由他桌空位移用。超額：1 桌 +2（餐自 5 桌）、3 桌 +1（餐自 7 桌）、13 桌 +1（餐自 9 桌）、17 桌 +1（餐自 6 桌）。移餐額度：5 桌空 2、6／7／9 桌各空 1。5／9 桌另留 1 空、10 桌預備不移餐。男方：主桌、12／16／17／19 新郎父親好友、15 江家親友、18／20／21 楊家親友、13／14 伊諾科技。女方：1／2 艾克森科技（1 桌含萬里雲科技）、3 創順科技、11 萬里雲科技、8 仁寶科技、6 葉家親友、5／7／9 林家親友、10 預備桌。主桌女方為林活汶、葉秋華、葉秋英、鄭森義。
            </div>
            <RosterList
              guests={guests}
              onSelect={(id) => {

        ...
        <div className="mx-auto flex max-w-[1600px] flex-col gap-3 px-4 py-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-xl text-sm text-[#92400e]">
              場地依 Grand Ballroom I 示意圖：面對舞台左側 10 桌（男方 12–21）、右側 10 桌（女方 1–3、5–11，無 4 號）。名單依 9/20 文華東方對照表。兒童座椅：1 桌 2、3 桌吳尹泰、13 桌 1、14 桌 1。紅點為 1 號位，順時針。
            </p>
          </div>
      ...
      <main className="mx-auto max-w-[1600px] px-4 py-4">
          ...
          <TabsContent value="roster" className="print:hidden">
            <div className="mb-4 rounded-xl border border-amber-200 bg-[#fffaf3] p-4 text-sm leading-relaxed text-[#7c2d12]">
              場地與示意圖相同：左 10 桌（12–21）、右 10 桌。名單依 9/20 文華東方對照表。加椅：1、2 桌各 11 席（餐自 5 桌）、13 桌 11 席（餐自 9 桌）、14 桌 11 席（餐自 8 桌）、17 桌 11 席（餐自 15 桌）。對照表另註 5 桌移至 1、2 桌各 1 位，7 桌移至 8、14 桌，9 桌移至 13 桌 2 位（13 桌大人椅只加 1）。6 桌 9 席、11 桌空 2 席、10 桌預備，不列入移餐。兒童座椅（不佔主位）：1 桌 2、3 桌吳尹泰、13 桌 1、14 桌 1。不吃牛 11 位、素食 1 位（17 桌張厚齊）。男方：主桌、12／16／17／19 新郎父親好友、15 江家親友、18／20／21 楊家、13／14 伊諾科技。女方：1 艾克森／萬里雲、2 艾克森、3 創順、8 萬里雲、11 仁寶、6 葉家、5／7／9 林家、10 預備桌。
            </div>
            <RosterList
              guests={guests}
              onSelect={(id) => {
